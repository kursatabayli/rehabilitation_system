...
if (count($staffList) == 0) {
  $content .= "
                    <div class='alert alert-danger at-3' role='alert'>
                        <p><i>Daha önce eklenen herhangi bir personel bulunamadı. <strong>Personel Ekle</strong> butonunu kullanarak yeni bir personel ekleyebilirsiniz</i></p>
                    </div>";
} else {
  $content .= "
  ...
  foreach ($staffList as $staff) {
    $content .= "
                                <tr>
                                    ...
                                    <td><a href='Detail.php?id={$staff['staffId']}' class='btn btn-outline-info'>Detay Gör</a></td>
                                    <td><a href='Update.php?id={$staff['staffId']}' class='btn btn-outline-success'>Güncelle</a></td>
                                    <td><button data-url='../../Controllers/StaffController.php?id={$staff['staffId']}' class='btn btn-outline-danger btn-sm btn-delete'>Sil</button></td>
                                </tr>";
    $counter++;
  }
