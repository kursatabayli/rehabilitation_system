...
foreach ($staffList as $staff) {
    $content .= "<option value='" . htmlspecialchars($staff['staffId']) . "'>" . htmlspecialchars($staff['name'] . ' ' . $staff['surname']) . "</option>";
}
...
foreach ($students as $student) {
    $content .= "<option value='" . htmlspecialchars($student['studentId']) . "'>" . htmlspecialchars($student['name'] . ' ' . $student['surname']) . "</option>";
}
