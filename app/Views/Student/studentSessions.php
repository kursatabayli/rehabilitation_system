...
<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12">
                <h4 class="card-title">Öğrenci Seans Türleri - <?php echo htmlspecialchars($student['name'] . ' ' . $student['surname'], ENT_QUOTES, 'UTF-8'); ?></h4>
                        ...
                        if (!empty($studentSessionTypes)) {
                            foreach ($studentSessionTypes as $studentSessionType) {
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <?php echo htmlspecialchars($studentSessionType['sessionType'], ENT_QUOTES, 'UTF-8'); ?> - Aylık Seans Sayısı: <?php echo htmlspecialchars($studentSessionType['monthlySessionNumber'], ENT_QUOTES, 'UTF-8'); ?>
                                    <button data-url="../../Controllers/StudentSessionTypeController.php?studentSessionTypeId=<?php echo htmlspecialchars($studentSessionType['studentSessionTypeId'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-danger btn-sm btn-delete">
                ...
                <div class="form-group mt-4">
                    <form id="sessionTypeForm" action="../../Controllers/StudentSessionTypeController.php" method="post">
                        ...
                        if ($hasSessionTypesToAdd) {
                            ...
                            <select id="sessionTypeDropdown" class="form-control" name="sessionTypeId">
                                ...
                                foreach ($allSessionTypes as $sessionType) {
                                    if (!in_array($sessionType['sessionTypeId'], $existingSessionTypeIds)) {
                                        ?>
                                        <option value="<?php echo htmlspecialchars($sessionType['sessionTypeId'], ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($sessionType['sessionType'], ENT_QUOTES, 'UTF-8'); ?></option>
                                        <?php
                                    }
                                }
                                ?>
                        ...
                        <a href="Detail.php?id=<?php echo htmlspecialchars($student['studentId'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-secondary mt-3">Geri Dön</a>
                    </form>
                </div>
            </div>
        </div>
