                ...
                <div class="col-xl-12">
                    ...
                    <form class="input-sm" data-action-type="update" action="../../Controllers/ProfessionController.php" method="post">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" id="professionName" name="professionName" value="<?php echo htmlspecialchars($profession['professionName'], ENT_QUOTES, 'UTF-8'); ?>" required>
                        </div>
