...
$studentSessionTypes = $studentModel->getSessionTypesByStudentId($studentId);
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="card-text">
                                    ...
                                    <?= htmlspecialchars($student['gender'] == 1 ? 'Erkek' : 'Kız', ENT_QUOTES, 'UTF-8') ?>
                                </p>
                ...
                <div class="text-center mt-4 mb-2">
                    <a href="Update.php?studentId=<?= htmlspecialchars($student['studentId'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary">Durum Güncellemesi</a>
